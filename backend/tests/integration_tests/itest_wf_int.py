...
def test_workflow_integration(mock_api, tmp_path, mock_config):
    ...
    with open(output_file) as f:
        ...
        assert data["commentary"] == "Comment Result"
        assert data["reconstruction"] == "Reconstruct Result"
        assert data["aggregated"] == "Final Aggregation"